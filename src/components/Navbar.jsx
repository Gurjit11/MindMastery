...
const Navbar = () => {
  ...
  return (
    ...
    height-40 font-semibold '>
      ...
      <div className='bg-gradient-to-r from-cyan-500 to-blue-500 drop-shadow-lg shadow-2xl  p-1 '>
        <div className='flex justify-between items-center'>
          <div>
            <h1 className='font-extrabold text-2xl cursor-pointer underline decoration-indigo-500 text-white ml-1'>
              <Link to='/'>MindMastery</Link></h1>
          </div>

          {user?.email ? (
            <div>
              <div className='hidden md:block'>
                <button className='text-white font-bold mx-1 mr-2 p-1 hover:scale-105'
            ...
            <div className="hidden md:block">
              ...
              <button className='text-white bg-gradient-to-r from-indigo-500 to-purple-500   font-semibold mx-1 py-2 my-1 rounded-3xl px-3 hover:scale-105'
      ...
      {/* sidebar */}
      <div className={sidebar ? 'md:hidden fixed left-0 top-15 flex flex-col items-center justify-between w-full h-[95%] bg-white ease-in duration-300 z-10 p-4 ':
